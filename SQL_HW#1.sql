...
--8. Вывести пользователей, у которых password 12333.
...
--12. Вывести пользователей, у которых в имени есть буква "а".
...
--31. Вывести id, имя, дату создания пользователей. Отсортировать по порядку возрастания даты добавления пользователей.

select ID, name, created_on
from students
order by created_on;

--32. Вывести id, имя, дату создания пользователей. Отсортировать по порядку убывания даты добавления пользователей.
